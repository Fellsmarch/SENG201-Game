...
public class GuessNumberPanel extends GamePanel {
	...
	public GuessNumberPanel(Hero challenger, Villain villain, boolean moreLucky) {
		...
		setLayout(new MigLayout("", "[grow][grow][grow]", "[50px:75px][50px:75px][50px:75px][50px:75px][]"));
		...
		add(tgl1, "flowy,cell 0 0,grow"); add(tgl2, "flowy,cell 1 0,grow"); add(tgl3, "flowy,cell 2 0,grow"); add(tgl4, "cell 0 1,grow");
		add(tgl5, "cell 1 1,grow"); add(tgl6, "cell 2 1,grow"); add(tgl7, "cell 0 2,grow"); add(tgl8, "cell 1 2,grow"); 
		add(tgl9, "cell 2 2,grow"); add(tgl10, "cell 1 3,grow");
...
//		numChoice.add(tgl6); numChoice.add(tgl7); numChoice.add(tgl8); numChoice.add(tgl9);
		...
		add(resultDisplay, "cell 0 4 3 1,grow");
	...
	public Result playGame() {
		...
		if (userGuess == villainsNumber) {return Result.WIN;}
			...
			if (moreLucky && userGuess - 1 == villainsNumber) {return Result.WIN;}
				...
				if (userGuess != 0) {resultDisplay.setString("Lower! - One guess left");}
				guessNum++;
				return Result.DRAW;
	...
	@Override
	public String toString() {return "Guess " + villain.getName() + "'s Number Game";}
}
